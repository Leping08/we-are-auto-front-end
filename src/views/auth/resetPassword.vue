<template>
  <div class="flex bg-gradient-to-r from-blue-400 to-blue-600 dark:from-blue-700 dark:to-blue-900 h-screen">
    <div class="m-auto w-5/6 md:w-2/3 lg:w-1/2 xl:w-1/3">
      <div class="p-8 bg-white dark:bg-gray-800 rounded-lg relative">
        ...
        <div class="my-4 flex items-center">
          ...
          />
          <div
            class="text-gray-500 dark:text-gray-300 pt-5 ml-2 cursor-pointer"
